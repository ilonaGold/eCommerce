...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    contributions: [
      ...
      "API integration for user profiles & addresses",
  ...
  },
  {
    ...
    contributions: [
      ...
      "Comprehensive documentation & unit tests with Vitest",
      ...
      "API integration for customer updates & address management",
      "User password change & profile edit functionality",
  ...
  },
  {
    ...
    contributions: [
      "Jira task board setup & update",
      "CommerceTools project & API client setup",
